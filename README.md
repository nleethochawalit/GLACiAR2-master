...
The main results produced by ``GLACiAR2`` can be summarised in three tables. These contain the information of the inserted galaxies, including their input properties and their output status and properties as well. They are described below.
