...
4.-10. St=xx: Number of artificial sources recovered with status xx.
11. N_Dropouts: Number of recovered sources with status $\geq$ 0 that passed the dropout selection criteria.
12. N_Recovered: Number of recovered sources with status $\geq$ 0.
13. Dropout_frac: Fraction of artificial sources that passed the selection criteria: N_Drop/N_Obj.
14. Rec: Fraction of not recovered artificial sources : N_Rec/N_Obj.
